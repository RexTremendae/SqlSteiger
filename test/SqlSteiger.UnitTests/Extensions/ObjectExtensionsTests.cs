...
public class ObjectExtensionsTests
{
    public static IEnumerable<object?[]> GetTestData() => new object?[][]
    {
        ...
        new object?[] { new TimeSpan(1, 2, 3), "'01:02:03'" },
        new object?[] { new DateTime(2019, 12, 11, 10, 59, 58), "'2019-12-11 10:59:58'" },
        new object?[] { new DateTimeOffset(2021, 01, 02, 10, 30, 29, TimeSpan.FromMinutes(62)), "'2021-01-02 10:30:29 +01:02'" },
        new object?[] { new Guid("6e9d585d-1011-4d40-9ae5-72e3b687032b"), "'6e9d585d-1011-4d40-9ae5-72e3b687032b'" },
        new object?[] { new Guid("6E9D585D-1011-4D40-9AE5-72E3B687032B"), "'6e9d585d-1011-4d40-9ae5-72e3b687032b'" },
    };
